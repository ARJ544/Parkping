...
export default function ReplyPage() {
  ...
  return (
    <div className="flex h-screen items-center justify-center px-4 transition-colors duration-300">
      <div className="w-full max-w-xs sm:max-w-sm rounded-2xl bg-brand-card dark:bg-neutral-800 shadow-xl p-5 sm:p-6 text-center border border-brand-reply-border dark:border-neutral-700">
