...
import { LayoutDonationWrapper } from "@/components/donations/LayoutDonationWrapper";
        ...
        <SerwistProvider swUrl="/serwist/sw.js">
          ...
          >
            <DonationProvider>
              ...
              <LayoutDonationWrapper>
                <Navigation />
                <OnlineOfflineComponent />
                {children}
              </LayoutDonationWrapper>

              <footer className="border-t border-white dark:border-slate-800 py-12">
