      ...
      <div className="max-w-3xl mx-auto px-8 py-16 flex flex-col gap-10">
        ...
        <div className="flex flex-col gap-10 text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
          ...
          <section className="flex flex-col gap-3">
            <h2 className="text-base font-bold text-brand-heading dark:text-slate-50">1. Agreement</h2>
            <p>
          ...
          <section className="flex flex-col gap-3">
            <h2 className="text-base font-bold text-brand-heading dark:text-slate-50">2. What {COMPANY_NAME} Is</h2>
            <p>
          ...
          <section className="flex flex-col gap-3">
            <h2 className="text-base font-bold text-brand-heading dark:text-slate-50">3. Eligibility</h2>
            <p>
          ...
          <section className="flex flex-col gap-3">
            <h2 className="text-base font-bold text-brand-heading dark:text-slate-50">4. Your Account</h2>
          ...
          <section className="flex flex-col gap-3">
            <h2 className="text-base font-bold text-brand-heading dark:text-slate-50">5. Acceptable Use</h2>
          ...
          <section className="flex flex-col gap-3">
            <h2 className="text-base font-bold text-brand-heading dark:text-slate-50">6. QR Codes & Item Registration</h2>
            <p>
          ...
          <section className="flex flex-col gap-3">
            <h2 className="text-base font-bold text-brand-heading dark:text-slate-50">7. Messaging</h2>
            <p>
          ...
          <section className="flex flex-col gap-3">
            <h2 className="text-base font-bold text-brand-heading dark:text-slate-50">8. Fees</h2>
            <p>
          ...
          <section className="flex flex-col gap-3">
            <h2 className="text-base font-bold text-brand-heading dark:text-slate-50">9. Intellectual Property</h2>
            <p>
          ...
          <section className="flex flex-col gap-3">
            <h2 className="text-base font-bold text-brand-heading dark:text-slate-50">10. Disclaimers</h2>
            <p>
          ...
          <section className="flex flex-col gap-3">
            <h2 className="text-base font-bold text-brand-heading dark:text-slate-50">11. Limitation of Liability</h2>
            <p>
          ...
          <section className="flex flex-col gap-3">
            <h2 className="text-base font-bold text-brand-heading dark:text-slate-50">12. Indemnification</h2>
            <p>
          ...
          <section className="flex flex-col gap-3">
            <h2 className="text-base font-bold text-brand-heading dark:text-slate-50">13. Service Changes</h2>
            <p>
          ...
          <section className="flex flex-col gap-3">
            <h2 className="text-base font-bold text-brand-heading dark:text-slate-50">14. Governing Law</h2>
            <p>
