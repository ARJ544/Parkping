        ...
        <div className="rounded-2xl border border-brand-border dark:border-zinc-800/80 bg-brand-card dark:bg-brand-card shadow-sm">
          <div className="flex flex-col items-center justify-center gap-4 p-6">
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 bg-stone-900 hover:bg-stone-800 dark:bg-brand-warm-text dark:text-brand-page dark:hover:bg-white text-white font-semibold text-sm sm:text-[14.5px] py-3.5 rounded-full transition-all duration-150 active:scale-[0.97] disabled:opacity-50 disabled:cursor-not-allowed"
            >
